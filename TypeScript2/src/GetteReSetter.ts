...
class Atendente {
    ...
    private salarioFuncionario:number
    
    constructor (nomeFuncionario:string, cpfFuncionario:number, salarioFuncionario:number){
        this.nomeFuncionario = nomeFuncionario;
        this.cpfFuncionario = cpfFuncionario;
        this.salarioFuncionario = salarioFuncionario;
    }

    get mostrarCPF():number {
        return this.cpfFuncionario;
    }
 
    set mudarSalario(valorSalario:number) {
