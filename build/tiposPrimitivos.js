...
console.log(banana2);
// Tipo Unknown
let notKnow = "Adm do Block Strike";
let notKnowConvert = notKnow;
let notKnowFinal = notKnowConvert;
console.log(notKnowFinal);
// Type Assertions
let bestBs = "Adm Brasileiro de Block Strike";
let bestBS = "Guerreiro demais";
bestBS = bestBs;
